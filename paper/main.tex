...
\title{Two Schedulers, One GPU:\\
When Gateway Micro-Batching Meets Continuous LLM Serving}
...
and backend time, batch formation, GPU telemetry, and harness validity.
\HeadlineResults
The result is a reproducible account of when a second scheduler adds useful
coalescing and when it merely moves queueing in front of an engine that already
