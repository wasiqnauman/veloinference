...
measured system. Conditions were executed in a fixed, recoverable order rather
than randomized or interleaved. Warmup, cooldown, and GPU telemetry expose
gross state changes, but they cannot remove slow temporal or thermal
confounding. Small cross-mode effects must therefore be interpreted more
cautiously than the within-mode queue and grouping mechanism.
